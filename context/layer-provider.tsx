...
export function LayerProvider({
  ...
  // SET LINKS
  const frontLink = 'https://pagamento.watchtuberewards.com/checkout/204056770:1?cid={{ad.id}}';
  const promoLink = 'https://pagamento.watchtuberewards.com/checkout/204056770:1?cid={{ad.id}}';
