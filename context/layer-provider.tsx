...
export function LayerProvider({
  ...
  // SET LINKS
  const frontLink = 'https://pay.hotmart.com/Q103021955O?off=vhn2gbpj&checkoutMode=10';
  const promoLink = 'https://pay.hotmart.com/Q103021955O?off=tyt15lds&checkoutMode=10';
